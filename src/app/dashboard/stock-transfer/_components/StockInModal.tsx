...
const INIT = {
  ...
  dealerId: '', sourceNote: '', referenceNo: '', date: '',
}

export default function StockInModal({ open, onClose, onSuccess }: Props) {
  ...
  useEffect(() => {
    setSerialNumbers([]); setSerialInput('')
  }, [form.productId])
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input placeholder="INV-001" value={form.referenceNo}
